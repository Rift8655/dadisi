      ...
      if (window.location.hash) {
        ...
        if (error) {
          ...
          if (error === 'signup_required') {
            errorMessage = "No account found with this email. Please sign up first before linking Google."
            ...
            errorMessage = "Please verify your email address first before linking Google authentication. Check your email for the verification link."
            console.log('Handling email_verification_required error - security block')
          } else {
        ...
        if (accessToken && userJson) {
          try {
            ...
            await showError("Authentication failed", "There was an error signing you in with Google.")
            router.push('/')
          }
        } else {
          await showError("Authentication failed", "Missing authentication data.")
          router.push('/')
        }
      }
    }
