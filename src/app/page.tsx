        ...
        <div className="container relative z-10 py-24">
          <div className="mx-auto max-w-2xl space-y-4 text-center text-white md:text-left">
            ...
            <p className="text-white/80">
              Dadisi Community Labs is revolutionizing science in Kenya by
              removing obstacles to STEM engagement and providing inclusive
      ...
      <section className="container">
        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          {[
            ...
            {
              title: "Dry Lab",
              img: "https://images.unsplash.com/photo-1583912372325-0c5be28e3590?q=80&w=1174&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
            },
            {
              title: "Greenhouse",
              img: "https://images.unsplash.com/photo-1516253593875-bd7ba052fbc5?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
            },
            {
              title: "Mobile Lab",
            ...
            <Card key={f.title}>
              <CardHeader>
                ...
                <CardDescription>
                  Available for schools, innovators and citizens.
                </CardDescription>
              </CardHeader>
              <CardContent>
