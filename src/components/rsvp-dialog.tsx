...
export function RsvpDialog({
  ...
  onSubmit: (details: RSVPDetails) => void
}) {
  const titleId = useId()
  ...
  return (
    <div className="fixed inset-0 z-[60]">
      ...
      />
      <div className="fixed left-1/2 top-1/2 w-[clamp(20rem,92vw,34rem)] -translate-x-1/2 -translate-y-1/2 p-4">
        <div
          role="dialog"
          aria-modal="true"
          aria-labelledby={titleId}
          className="relative max-h-[min(90vh,36rem)] w-full overflow-y-auto rounded-xl border bg-card text-card-foreground shadow-2xl"
        >
